            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="uploadImage" action="{{ route('admin.editadodisciplina',['id'=>$disciplina->id]) }}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                @csrf
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" maxlength="70" id="nome_curso"  name="nome_curso" class="form-control" value="{{ $disciplina->nome }}">
                                </div>
                                </div>
                                <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Descrição</label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" maxlength="255" name="descricao_curso" id="descricao_curso" value="{{ $disciplina->descricao }}">
                                </div>
                                </div>
                                <div class="form-group row mb-4">
                                ...
                                <div class="form-group row mb-4">
                                    <div class="col-sm-12 col-md-7">
                                        <input type="hidden" name="id_disciplina" id="id_disciplina" value="{{ $disciplina->id }}">
                                        <input type="hidden" name="id_curso" id="id_curso" value="{{ $disciplina->id_curso }}">
